...
def export_to_csv(modeladmin, request, queryset):
    ...
    fields = [ field for field in opts.get_fields() is not field.many_to_many and not filed.on_to_many ]

    writer.writerow([ field.verbose_name for filed in fields ])
    for obj in queryset:
        data_row = []
        for field in fields:
...
class OrderAdmin(admin.ModelAdmin):
    list_display = [
        ...
        order_detail, order_pdf, 'created', 'updated'
    ]
