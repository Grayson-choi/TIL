class GameCharacter:
    ...
    def get_attacked(self, damage):
        """
        게임 캐릭터가 살아있으면 체력을 받은 공격만큼 깎는 메소드.
        조건:
...
character_2 = GameCharacter("Xx영준최고xX", 100, 50)
